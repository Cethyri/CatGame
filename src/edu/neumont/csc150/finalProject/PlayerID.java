...
public enum PlayerID {
	...
	SECOND(new Color(0, 102, 102), KeyEvent.VK_UP, KeyEvent.VK_DOWN, KeyEvent.VK_LEFT, KeyEvent.VK_RIGHT, KeyEvent.VK_PAGE_DOWN, KeyEvent.VK_PAGE_DOWN, MainFrame.CONTENT_WIDTH / 4 + MainFrame.CONTENT_WIDTH / 8),
	...
	FOURTH(new Color(102, 0, 204), KeyEvent.VK_I, KeyEvent.VK_K, KeyEvent.VK_J, KeyEvent.VK_L, KeyEvent.VK_R, KeyEvent.VK_Y, MainFrame.CONTENT_WIDTH / 4 * 3 + MainFrame.CONTENT_WIDTH / 8);
