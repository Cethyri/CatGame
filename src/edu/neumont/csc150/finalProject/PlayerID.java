...
public enum PlayerID {
	FIRST(new Color(102, 0, 0), KeyEvent.VK_LEFT, KeyEvent.VK_RIGHT, KeyEvent.VK_UP, KeyEvent.VK_DOWN, KeyEvent.VK_PAGE_DOWN, KeyEvent.VK_PAGE_DOWN, 0),
	...
	THIRD(new Color(204, 102, 0), KeyEvent.VK_F, KeyEvent.VK_H, KeyEvent.VK_T, KeyEvent.VK_G, KeyEvent.VK_U, KeyEvent.VK_O, MainFrame.CONTENT_WIDTH / 4 * 2),
	FOURTH(new Color(102, 0, 204), KeyEvent.VK_J, KeyEvent.VK_L, KeyEvent.VK_I, KeyEvent.VK_K, KeyEvent.VK_R, KeyEvent.VK_Y, MainFrame.CONTENT_WIDTH / 4 * 3);
